...
import type { PropertyCategory, UtilityStatus, ImportantDate } from '../types/properties'
...
export const inputCls = 'w-full h-8 px-3 rounded-lg bg-zinc-50 border border-[rgba(0,0,0,0.08)] text-[12px] text-ink placeholder:text-zinc-400 focus:outline-none focus:border-zinc-400 focus:bg-white transition-colors'
export const selectCls = 'w-full h-8 px-3 rounded-lg bg-zinc-50 border border-[rgba(0,0,0,0.08)] text-[12px] text-ink focus:outline-none focus:border-zinc-400 focus:bg-white transition-colors appearance-none'
